 ...
 * on 2016-01-02 at 00:20:20 UTC 
 * Modify at your own risk.
 */

package com.taehun.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://build-it-bigger-1173.appspot.com/_ah/api/";
  ...
  public class SayHi extends MyApiRequest<com.taehun.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.taehun.myapplication.backend.myApi.model.MyBean.class);
